'''
Conceitos:
1. Teste Unitário -> módulo unittest
2. Suíte de Testes -> test_fizzbuzz.py
3. Caso de Teste -> FizzBuzzTest(unittest.TestCase)
4. Métodos de Teste -> Ex: test_say_fizzbuzz_when_45(self)
'''
